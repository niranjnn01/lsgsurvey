...
<div class="fc signup_form">
	...
	<div class="fro" align="center">
		...
		<div class="fr ">
			...
			<div class="l">
				<input type="text" id="email_id" name="email_id" value="<?php echo 	set_value('email_id', $email);?>"/>
			</div>
	...
	<div class="fro" align="center">
		...
		<div>&nbsp;:&nbsp;</div>
		<div class="fr ">
			<input type="text" name="middle_name" value="<?php echo set_value('middle_name', $middle_name);?>"/>
		</div>
	</div>
	...
	<div class="fro" align="center">
		...
		<div>&nbsp;:&nbsp;</div>
		<div class="fr ">
			<?php $iDefault = set_value('gender', $gender) ?>
			<?php echo form_dropdown('gender', $aGenders, $iDefault);?>
		</div>
	</div>
	...
	<div class="fro" align="center">
		...
		<div>&nbsp;:&nbsp;</div>
		<div class="fr ">
			<div><input type="text" name="dob" readonly="true" value="<?php echo set_value('dob', $dob);?>" id="datepicker"/></div>
		</div>
	</div>
