...
<div></div>
	...
	<div class="col-md-12">
        ...
        <input type="text" name="program_director_url"  class="col-md-12" value="<?php echo set_value('program_director_url') ? set_value('program_director_url') : '';?>"/>
	</div>
	...
	<div class="col-md-12">
		...
		<label for="project_type">Resource ID</label>
			<div class="resources">
				<input type="text" name="resource_id[]" class="res span12"/>
