...
<?php echo form_open('user/edit/'.$iAccountNo, 'id = "userEdit"')?>
...
<div class="col-md-8">
	...
	<div class="form-group">
		...
		<?php echo form_dropdown('status', $aUserStatusFlipped, $oUser->status, 'class="form-control"');?>
	</div>
	
	<div class="form-group">
		<label for="status">Gender</label>
		<?php echo form_dropdown('gender', $aGendersFlipped, $oUser->gender, 'class="form-control"');?>
	</div>
